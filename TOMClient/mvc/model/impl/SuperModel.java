...
public class SuperModel implements IModel
{
	...
	protected int				scenario_ID				= IModel.DEFAULT_INT;
	public static final String	SCENARIO				= "2";
	protected String			scenario				= IModel.DEFAULT_STRING;
	public static final String	SELECTION_MANMANMAN		= "3";
	protected String			selection_ManManMan		= IModel.DEFAULT_STRING;
	public static final String	SELECTION_MANMANWOMAN	= "4";
	protected String			selection_ManManWoman	= IModel.DEFAULT_STRING;
	public static final String	SELECTION_MANWOMANWOMAN	= "5";
	protected String			selection_ManWomanWoman	= IModel.DEFAULT_STRING;
	public static final String	USER_ID					= "6";
	protected int				user_ID					= IModel.DEFAULT_INT;
	public static final String	USER_EMAIL				= "7";
	protected String			user_Email				= IModel.DEFAULT_STRING;
	public static final String	LANGUAGE_ID				= "8";
	protected int				language_ID				= IModel.DEFAULT_INT;
	public static final String	PIN						= "9";
	protected int				pin						= IModel.DEFAULT_INT;
	public static final String	FRIEND_ID				= "10";
	protected int				friend_ID				= IModel.DEFAULT_INT;
	public static final String	FRIEND_EMAIL			= "11";
	protected String			friend_Email			= IModel.DEFAULT_STRING;
	public static final String	ALIAS					= "12";
	protected String			alias					= IModel.DEFAULT_STRING;
	public static final String	STATUS					= "13";
	protected int				status					= IModel.DEFAULT_INT;
	public static final String	RESULT					= "14";
	protected int				result					= IModel.DEFAULT_INT;

	public SuperModel()
	{
		super();
		this.scenario_ID = IModel.DEFAULT_INT;
		...
		this.user_ID = IModel.DEFAULT_INT;
		this.user_Email = IModel.DEFAULT_STRING;
		this.language_ID = IModel.DEFAULT_INT;
	...
	{
		if (this.scenario_ID == superModelToCompareTo.scenario_ID && this.scenario.equals(superModelToCompareTo.scenario)
			...
			&& this.selection_ManWomanWoman.equals(superModelToCompareTo.selection_ManWomanWoman) && this.user_ID == superModelToCompareTo.user_ID
			&& this.user_Email.equals(superModelToCompareTo.user_Email) && this.language_ID == superModelToCompareTo.language_ID && this.pin == superModelToCompareTo.pin
			&& this.friend_ID == superModelToCompareTo.friend_ID && this.friend_Email.equals(superModelToCompareTo.friend_Email)
			&& this.alias.equals(superModelToCompareTo.alias) && this.status == superModelToCompareTo.status && this.result == superModelToCompareTo.result)
		{
			return true;
		}
		else
