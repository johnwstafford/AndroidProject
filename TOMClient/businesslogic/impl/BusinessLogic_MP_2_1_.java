...
public class BusinessLogic_MP_2_1_ extends SuperBusinessLogic implements IModel
{
	private FriendshipHandler			friendHandler				= null;
	private MultiplayerScenarioHandler	multiplayerScenarioHandler	= null;

	public BusinessLogic_MP_2_1_(Activity activity)
	{
		super(activity);
	...
	{
		List<MultiplayerScenario> multiplayerScenarioListOfFriend_ID = new ArrayList<MultiplayerScenario>(0);

		for (MultiplayerScenario multiplayerScenario : multiplayerScenarioHandler.getAllMultiplayerScenariosFromLocalDatabase())
		{
			if (multiplayerScenario.getCreatedFor_ID() == createdFor_ID)
			{
				multiplayerScenarioListOfFriend_ID.add(multiplayerScenario);
			}
		}
		return multiplayerScenarioListOfFriend_ID;
	}
}