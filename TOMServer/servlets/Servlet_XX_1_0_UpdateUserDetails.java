 ...
 */
@WebServlet("/Servlet_XX_1_0_UpdateUserDetails")
public class Servlet_XX_1_0_UpdateUserDetails extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_XX_1_0_UpdateUserDetails()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_XX_1_0_ businessLogic_XX_1_0_ = new BusinessLogic_XX_1_0_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_XX_1_0_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (businessLogic_XX_1_0_.executeSQL(superModel.getAlias(), superModel.getPin(), superModel.getUser_ID()))
								{
