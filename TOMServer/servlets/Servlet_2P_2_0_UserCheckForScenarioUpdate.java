...
/**
 * Servlet implementation class Servlet_2p_2_0_UserCheckForScenarioUpdate
 */
@WebServlet("/Servlet_2P_2_0_UserCheckForScenarioUpdate")
public class Servlet_2P_2_0_UserCheckForScenarioUpdate extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_2P_2_0_UserCheckForScenarioUpdate()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_2P_2_0_ businessLogic_2P_2_0_ = new BusinessLogic_2P_2_0_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_2P_2_0_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (businessLogic_2P_2_0_.executeSQL(superModel))
								{
