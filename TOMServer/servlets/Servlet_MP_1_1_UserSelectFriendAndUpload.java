...
/**
 * Servlet implementation class Servlet_MP_1_1_UserSelectFriendAndUpload
 */
@WebServlet("/Servlet_MP_1_1_UserSelectFriendAndUpload")
public class Servlet_MP_1_1_UserSelectFriendAndUpload extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_MP_1_1_UserSelectFriendAndUpload()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_MP_1_1_ businessLogic_MP_1_1_ = new BusinessLogic_MP_1_1_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_MP_1_1_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (businessLogic_MP_1_1_.executeSQL(superModel))
								{
