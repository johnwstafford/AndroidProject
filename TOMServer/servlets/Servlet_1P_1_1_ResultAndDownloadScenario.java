...
/**
 * Servlet implementation class Servlet_1p_1_1_ResultAndDownloadScenario
 */
@WebServlet("/Servlet_1P_1_1_ResultAndDownloadScenario")
public class Servlet_1P_1_1_ResultAndDownloadScenario extends ServerHttpServlet implements IModel
{
	private static final long	serialVersionUID		= 1L;
	BusinessLogic_1P_1_1_		businessLogic_1P_1_1_1	= null;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Servlet_1P_1_1_ResultAndDownloadScenario()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_1P_1_1_ businessLogic_1P_1_1_ = new BusinessLogic_1P_1_1_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_1P_1_1_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (businessLogic_1P_1_1_.executeSQL(superModel))
								{
