...
/**
 * Servlet implementation class Servlet_2p_3_1_PlayScenarioFromFriend
 */
@WebServlet("/Servlet_2P_3_1_PlayScenarioFromFriend")
public class Servlet_2P_3_1_PlayScenarioFromFriend extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_2P_3_1_PlayScenarioFromFriend()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_2P_3_1_ businessLogic_2P_3_1_ = new BusinessLogic_2P_3_1_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_2P_3_1_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (superModel.getStatus() == constants.DatabaseConstants.TWO_PLAYER_2_RESULT_READY_FOR_DOWNLOAD_BY_USER)
								{
									if (businessLogic_2P_3_1_.executeSQL_UpdateResult(superModel))
									{
								...
								{
									// It MUST be superModel.getStatus() == TWO_PLAYER_4_NO_LONGER_AVAILABLE
									if (businessLogic_2P_3_1_.executeSQL_DeleteScenario(superModel.getScenario_ID()))
									{
