...
import businesslogic.impl.BusinessLogic_2P_3_0_R;
import datapackaging.DataPackaging;

/**
 * Servlet implementation class Servlet_2p_3_0_RetrieveScenarioPlayingDetails
 */
@WebServlet("/Servlet_2P_3_0_RetrieveScenarioPlayingDetails")
public class Servlet_2P_3_0_RetrieveScenarioPlayingDetails extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_2P_3_0_RetrieveScenarioPlayingDetails()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_2P_3_0_R businessLogic_2P_3_0_R = new BusinessLogic_2P_3_0_R(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_2P_3_0_R.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());

						switch (resultOfConnection)
						{
							case 0:
								if (businessLogic_2P_3_0_R.executeSQL(superModel))
								{
									outputStreamWriter.write(dataPackaging.serialize_SuperModel_To_JSONObject(superModel).toString());
								}
								else
								{
									// Indicates to Client that no data found
