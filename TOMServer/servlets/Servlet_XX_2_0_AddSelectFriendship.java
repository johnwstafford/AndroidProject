...
/**
 * Servlet implementation class Servlet_2p_1_1_UserSelectFriendAndUpload
 */
@WebServlet("/Servlet_XX_2_0_AddSelectFriendship")
public class Servlet_XX_2_0_AddSelectFriendship extends ServerHttpServlet implements IModel
{
	 ...
	 */
	public Servlet_XX_2_0_AddSelectFriendship()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if (isServerListeningForRequests)
		{
			...
			final BusinessLogic_XX_2_0_ businessLogic_XX_2_0_ = new BusinessLogic_XX_2_0_(this.getDatasourceConnection());
			...
			if (!stringBuilder.equals(DEFAULT_STRING))
			{
				try
				{
					...
					{
						final int resultOfConnection = businessLogic_XX_2_0_.isConnectionAvailableAndRequestInformationCompliant(superModel.getUser_ID());
						...
						switch (resultOfConnection)
						{
							case 0:
								...
								{
									// Check if Friend_Email is in database
									// Database connection NOT closed in "executeSQL_CheckUserInDatabase"
									// as "executeSQL_CheckFriendshipInDatabase" requires it
									if (businessLogic_XX_2_0_.executeSQL_CheckUserInDatabase(superModel))
									{
										// If the Friend_Email is in the database
										// their Friend_ID MUST be set
										if (superModel.getFriend_ID() != DEFAULT_INT)
										{
											if (businessLogic_XX_2_0_.executeSQL_CheckFriendshipInDatabase(superModel))
											{
										...
										{
											// Flag to client that Friend not in database
								...
								else
								{
									...
									if (businessLogic_XX_2_0_.executeSQL_GetFriendshipInDatabase(superModel))
									{
										outputStreamWriter.write(dataPackaging.serialize_SuperModel_To_JSONObject(superModel).toString());
									}
									else
